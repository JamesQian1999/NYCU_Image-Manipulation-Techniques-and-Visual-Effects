...
lr_scheduler_D = optim.lr_scheduler.MultiStepLR(optimizerD, milestones=[50, 80, 100], gamma=0.5)
optimizerG = optim.Adam(netG.parameters(), lr=lr, betas=(beta1, 0.999))
lr_scheduler_G = optim.lr_scheduler.MultiStepLR(optimizerG, milestones=[50, 80, 100], gamma=0.5)
